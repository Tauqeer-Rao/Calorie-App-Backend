...
describe('service: User', () => {
    ...
    test('It should return user obj on successfully register', async () => {
        ...
        const result = await UserService.create({ email: 'syedRohaanhussain@gmail.com', password: '123123' });
    ...
    test('It should throw error from create user function in success case', async () => {
        ...
        await expect(UserService.create({ email: 'syedRohaanhussain@gmail.com', password: '123123' })).rejects.toThrow('code crashed!');
    });
    ...
    test('It should return user object with token on successfully login', async () => {
        ...
        const result = await UserService.loginUser({ email: 'syedRohaanhussain@gmail.com', password: '123123' });
        expect(result).toStrictEqual(userFixture.returnLoggedInUser());
    });
    ...
    test('It should throw error from loginUser function in success case', async () => {
        ...
        await expect(UserService.loginUser({ email: 'syedRohaanhussain@gmail.com', password: '123123' })).rejects.toThrow('code crashed!');
    });
    ...
    test('It should return invite user credentials on successfully register', async () => {
        ...
        const result = await UserService.inviteFriend({ email: 'syedRohaanhussain@gmail.com' });
    ...
    test('It should throw error from invite friend in success case', async () => {
        ...
        await expect(UserService.create({ email: 'syedRohaanhussain@gmail.com' })).rejects.toThrow('code crashed!');
    });
});
